...
template_files = [
    ...
    "rectangle.jpg", 
    "semicircle.jpg", 
    "circle_arrow.jpg",    # circle with arrow cutout
    "rectangle_arrow.jpg", # rectangle with arrow cutout
    ...
    for template in templates:
        ...
        if len(good_matches) >= MIN_MATCH_COUNT:
            ...
            if M is not None:
                ...
                scene_corners = np.int32(scene_corners)  # convert to integer pixel coordinates

                # Draw a polygon (bounding box) around the detected template in the frame
                cv2.polylines(frame, [scene_corners], isClosed=True, color=(0, 255, 0), thickness=2)
